...
//FWMemoVirtual( oStruZA2, { { 'ZA2_CDSYP1', 'ZA2_MMSYP1' }, { 'ZA2_CDSYP2', 'ZA2_MMSYP2' } } )
...
oModel:AddGrid( 'ZA2DETAIL', 'ZA1MASTER', oStruZA2, /*bLinePre*/, /*bLinePost*/, bLinePre/*bPreVal*/, /*bPosVal*/, /*BLoad*/ )
