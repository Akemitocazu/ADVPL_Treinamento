...
oModel:AddGrid( 'ZA5DETAIL', 'ZA4DETAIL', oStruZA5, /*bLinePre*/,/*{||delLine()}*/ /*bLinePost*/, /*bPreVal*/, /*bPosVal*/, /*BLoad*/ )
...
oView:EnableTitleView('VIEW_ZA5' , 'INTERPRETES DAS MÚSICAS' , RGB(0,0,0 )  ) 
...
//  abaixo a cofiguração para chamar este metodo 
