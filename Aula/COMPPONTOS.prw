...
ElseIf cIdPonto ==  'MODELCOMMITNTTS'
	...
	If oObj:GetOperation() == 2//visualização	
		ApMsgInfo("Visualizar")
	Elseif	oObj:GetOperation()==3 //Inclusao
		ApMsgInfo("Inclusão")
	ElseIf oObj:GetOperation()==4 //Alterar
		ApMsgInfo("Alterar")
	Else
...
ElseIf cIdPonto ==  'MENUDEF'
    ...
    ApMsgInfo('Adicionando Botao na MenuDef (MENUDEF).' + CRLF + 'ID '  + cIdModel )
	xRet := { { 'Teste'    , 'MSGINFO("TESTE menu")', 0, 9, 0, NIL }  }
