...
@version P10
/*/
//Anotacoes de aula: não é possível reutilizar o menu, o reuso é em cima do modelo. Procede?
//-------------------------------------------------------------------
...
//posiciona para este programa
	...
	ADD OPTION aRotina TITLE 'Im&primir'   ACTION 'VIEWDEF.COMP011_MVC' OPERATION 8 ACCESS 0
...
//reuso do modelo de dados
//mvc exageradamente cheio de controles
...
// -- estrutura v- são propriedades, mas diferentes
//	MODEL_FIELD_TITULO 
//	MODEL_FIELD_TOOLTIP 
//	MODEL_FIELD_IDFIELD 
//	MODEL_FIELD_TIPO    
...
//oStruZA0:SetProperty( 'A1_CGC'         , MODEL_FIELD_OBRIGAT, .T. )   

// Cria o objeto do Modelo de Dados
//oModel := MPFormModel():New('COMP011M', /*bPreValidacao*/, /*bPosValidacao*/, /*bCommit*/, /*bCancel*/ )
	oModel := MPFormModel():New('COMP011MODEL', /*bPreValidacao*/, { |oModel| COMP011POS( oModel ) }, /*bCommit*/, /*bCancel*/ )
...
// Adiciona a descricao do Componente do Modelo de Dados - na estrutura dentro do modelo
...
//1: modelo 2: validação
	oStruZA0:AddGroup( 'GRUPO01', 'Alguns Dados', '', 2 )
...
Static Function COMP011POS( oModel )
	...
	If nOperation == 4 //operação tipo 4: alteração
		If Empty( oModel:GetValue( 'ZA0MASTER', 'ZA0_DTAFAL' ) )
			//oModel:GetModel("ZA0MASTER"):GetValue("ZA0_DTAFAL")


			oModel:GetModel( 'ZA0MASTER' )
			//oModel:SetValue("ZA0MASTER","ZA0_DTAFAL", CtoD(01/01/2018))
